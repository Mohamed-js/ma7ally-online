        ...
        <div className="first-three-groups">
          <div className="first-two-groups">
            ...
            <div className="second-group">
              <div className="one-line-card curved bg-gradient-secondary white">
                LAZY USERS:{' '}
              ...
              <div className="flex-row justify-between grid-column">
                <div className="w-100">
                  <div className="three-line-card flex-col curved bg-gradient-tertiary white">
                    <h5>TOTAL ORDERS</h5>
                    <span className="number"> {store.store.total_orders} </span>
                  </div>
                ...
                <div className="w-100">
                  <div className="three-line-card flex-col curved bg-gradient white">
                    <h5>MONTH ORDERS</h5>
                    <span className="number">{store.store.month_orders} </span>
                  </div>
